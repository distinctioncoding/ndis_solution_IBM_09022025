package com.larry.pojo.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseMessage<String>> handleResourceNotFoundException(ResourceNotFoundException ex, HttpServletRequest request)
    {
